...
class Utils:
    ...
    def open_file(self):
        ...
        self.open_btn.config( relief=tkinter.FLAT)
    ...
    def save_file(self):
        ...
        self.save_btn.config( relief=tkinter.FLAT)
    ...
    def save_as(self):
        ...
        self.saveas_btn.config( relief=tkinter.FLAT)
    ...
    def copy_(self):
        ...
        self.copy_btn.config( relief=tkinter.FLAT)
    ...
    def paste_(self):
        ...
        self.paste_btn.config( relief=tkinter.FLAT)
    ...
    def cut_(self):
        ...
        self.cut_btn.config( relief=tkinter.FLAT)
    ...
    def undo_(self):
        ...
        self.undo_btn.config( relief=tkinter.FLAT)
    ...
    def redo_(self):
        ...
        self.redo_btn.config(relief=tkinter.FLAT)
